...
* Well-architected, easy to maintain, and virtually free of defects
* Mostly structured, maintainable with modest effort, and has few defects
* Structured in parts, requires frequent refactoring, and has occasional defects
* Inconsistent structure, difficult to maintain, and produces noticeable defects
* Poorly structured, risky to modify, and generates frequent defects
* Ad-hoc, unmaintainable, and heavily bug-ridden
